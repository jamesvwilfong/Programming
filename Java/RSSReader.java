...
public final class RSSReader {
    ...
    public static void main(String[] args) {
        ...
        while (xml.label().compareTo("rss") != 0 || xml.isTag() == false) {
            System.out.println("Not a rss file, enter new URL: ");
            url = in.nextLine();
            xml = new XMLTree1(url);
        }
        while (xml.hasAttribute("version") == false) {
            System.out.println(
                    "RSS file does not contain version attribute, provide new URL: ");
            url = in.nextLine();
            xml = new XMLTree1(url);
        }
        while (xml.attributeValue("version").compareTo("2.0") != 0) {
            System.out.println("RSS is not version 2.0, provide new URL: ");
            url = in.nextLine();
            xml = new XMLTree1(url);
        }
        ...
        SimpleWriter out = new SimpleWriter1L(htmlFileName);
        while (htmlFileName.length() < 5 || htmlFileName
                .substring(htmlFileName.length() - 5).compareTo(".html") != 0) {
            System.out.println("Output file name: ");
            htmlFileName = in.nextLine();
            out = new SimpleWriter1L(htmlFileName);
        }
