...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        this.tTop.setSize(TEXT_AREA_WIDTH, TEXT_AREA_HEIGHT);
        this.tBottom.setSize(TEXT_AREA_WIDTH, TEXT_AREA_HEIGHT);
         ...
         */
        JPanel main = new JPanel(new GridLayout(MAIN_BUTTON_PANEL_GRID_ROWS,
         ...
         * to bottom
         */
        main.add(this.bDigits[7]);
        main.add(this.bDigits[8]);
        main.add(this.bDigits[9]);
        main.add(this.bAdd);
        main.add(this.bDigits[4]);
        main.add(this.bDigits[5]);
        main.add(this.bDigits[6]);
        main.add(this.bSubtract);
        main.add(this.bDigits[1]);
        main.add(this.bDigits[2]);
        main.add(this.bDigits[3]);
        main.add(this.bMultiply);
        main.add(this.bDigits[0]);
        main.add(this.bPower);
        main.add(this.bRoot);
        main.add(this.bDivide);
         ...
         */
        super.setLayout(new GridLayout(CALC_GRID_ROWS, CALC_GRID_COLUMNS));
